...
namespace ProjectDemolition.Role
{
    public partial class UserRole : PageBase
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                btnImport.OnClientClick = Window1.GetShowReference("~/Role/UserRoleSet.aspx");
                BindGrid();
            }
        }
        ...
        private DataTable GetPagedDataTable()
        {
            ...
            string sql = "select ur.Id, ut.Name,r.RoleName from UserRole as ur left join UserTable as ut  on ur.UsedId=ut.Id left join Role as r on ur.RoleId=r.Id";
            DataTable dt = DBAccess.QueryDataTable(sql);
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string sql = "delete from UserRole where Id in(" + ids + ")";
