<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="User.aspx.cs" Inherits="ProjectDemolition.User.User" %>
<!DOCTYPE html>
    ...
    <Items>
        <f:Grid ID="Grid1" Title="用户信息"   Width="100%" PageSize="5" ShowBorder="true" ShowHeader="true"
            ...
            <Columns>
                ...
                <f:BoundField ID="Name" DataField="Name" HeaderText="用户名"></f:BoundField>
