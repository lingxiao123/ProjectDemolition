<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="ProjectDemolition.Index" %>
                    ...
                    <Content>
                        <div id="header">
                            <table>
                                <tr>
                                    <td>
                                        <img src="Imgs/tplusstd_skinOne.png" alt="于都拆迁系统" />
                                    </td>
                                    <td>&nbsp;&nbsp;&nbsp;&nbsp;于都拆迁系统
                                    </td>
                                </tr>
            ...
            function MenuThemeItemCheckChange(cmp, checked) {
                if (checked) {
                    ...
                    if (cmp.id.indexOf('MenuThemeBlue') >= 0) {
                        lang = 'blue';
                    } else if (cmp.id.indexOf('MenuThemeNeptune') >= 0) {
                        lang = 'neptune';
