<%@ Page Title="管理帐户" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="ProjectDemolition.Account.Manage" %>
            ...
            <div class="form-horizontal">
                ...
                <dl class="dl-horizontal">
                    ...
                    <%--
                       ...
                       有关如何设置此 ASP.NET 应用程序以支持使用
                        SMS 进行双因素身份验证的详细信息，请参阅<a href="http://go.microsoft.com/fwlink/?LinkId=403804">此文章</a>。
                        在设置双因素身份验证后，请取消注释以下块
                    --%>
                    <%--
                    <dt>电话号码:</dt>
                    <% if (HasPhoneNumber)
                    ...
                    <dd>
                        <p>
                            未配置双因素身份验证提供程序。请参阅<a href="http://go.microsoft.com/fwlink/?LinkId=403804">此文章</a>，
